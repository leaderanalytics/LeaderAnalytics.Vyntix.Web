                ...
                <div className="app">
                    ...
                    <div className="appDescription">
                        ...
                        <a className="downloadButton"
                            href="https://github.com/leaderanalytics/Observer.Desktop/releases/download/windows%2F1.1.2.1/LeaderAnalytics.Vyntix.Observer.Desktop-win-Setup.exe"
            ...
            <div className="appList">
                ...
                <div className="app">
                    ...
                    <div className="appDescription">
                        ...
                        <a className="downloadButton"
                            href="https://github.com/leaderanalytics/Observer.CLI/releases/download/windows%2F1.1.2.1/LeaderAnalytics.Vyntix.Observer.CLI-win-Setup.exe"
