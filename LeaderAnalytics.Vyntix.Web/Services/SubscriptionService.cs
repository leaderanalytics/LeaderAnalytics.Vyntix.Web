...
public class SubscriptionService : ISubscriptionService
{
    ...
    public List<SubscriptionPlan> GetSubscriptionPlans()
    {
        ...
        subscriptionPlans = System.Text.Json.JsonSerializer.Deserialize<List<SubscriptionPlan>>(System.IO.File.ReadAllBytes(subscriptionFile));
        ...
        int freePlanCount = subscriptionPlans.Count(x => x.PlanDescription == LeaderAnalytics.Vyntix.Web.Domain.Constants.FREE_PLAN_DESC);
    ...
    public async Task<CreateSubscriptionResponse> ApproveSubscriptionOrder(SubscriptionOrder order)
    {
        ...
        if (order.SubscriptionPlan.PlanDescription == LeaderAnalytics.Vyntix.Web.Domain.Constants.FREE_PLAN_DESC && order.PriorSubscriptions.Any())
    ...
    public async Task<CreateSubscriptionResponse> CreateSubscription(SubscriptionOrder order, string hostURL)
    {
        ...
        {
            response.ErrorMessage = System.Text.Json.JsonSerializer.Deserialize<string>(await captchaResult.Content.ReadAsStringAsync());
            return response;
        }
    ...
    {
        System.Net.Mail.LinkedResource image = new System.Net.Mail.LinkedResource("ClientApp\\public\\VyntixLogo.png", "image/png");
